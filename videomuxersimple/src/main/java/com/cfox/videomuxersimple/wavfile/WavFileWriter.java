package com.cfox.videomuxersimple.wavfile;
...
public class WavFileWriter {
    ...
    public boolean openFile(String filepath, int sampleRateInHz, int channels, int format) throws IOException {
        Log.d(TAG, "sampleRateInHz:" + sampleRateInHz + " channels:" + channels + " bitsPerSample:" + getBitsPerSample(format));
        ...
        return writeHeader(sampleRateInHz, channels , getBitsPerSample(format));
    }
